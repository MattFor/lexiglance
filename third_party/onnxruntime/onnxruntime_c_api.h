...
typedef OrtStatus* OrtStatusPtr;
	 ...
	 *                    ORT will release the OrtStatus* if not null.
	 */
	typedef OrtStatus*( ORT_API_CALL* OrtWriteBufferFunc )( _In_ void* state, _In_ const void* buffer, _In_ size_t buffer_num_bytes );
...
// Previous enum values added for backwards compatibility
	...
	struct OrtApi
	{
		 ...
		 * \snippet{doc} snippets.dox OrtStatus Return Value
		 */
		ORT_API2_STATUS( CreateEnvWithCustomLogger, _In_ OrtLoggingFunction logging_function, _In_opt_ void* logger_param, _In_ OrtLoggingLevel log_severity_level, _In_ const char* logid, _Outptr_ OrtEnv** out );
		 ...
		 * \since Version 1.14
		 */
		ORT_API2_STATUS( KernelInfo_GetInputName, _In_ const OrtKernelInfo* info, size_t index, _Out_opt_ char* out, _Inout_ size_t* size );
		 ...
		 * \since Version 1.14
		 */
		ORT_API2_STATUS( KernelInfo_GetOutputName, _In_ const OrtKernelInfo* info, size_t index, _Out_opt_ char* out, _Inout_ size_t* size );
		 ...
		 * \since Version 1.16.
		 */
		ORT_API2_STATUS( KernelContext_GetResource, _In_ const OrtKernelContext* context, _In_ int resource_version, _In_ int resource_id, _Outptr_ void** resource );
		 ...
		 * \since Version 1.17.
		 */
		ORT_API2_STATUS( SetUserLoggingFunction, _Inout_ OrtSessionOptions* options, _In_ OrtLoggingFunction user_logging_function, _In_opt_ void* user_logging_param );
		 ...
		 * \since Version 1.17.
		 */
		ORT_API2_STATUS( SessionOptionsAppendExecutionProvider_OpenVINO_V2, _In_ OrtSessionOptions* options, _In_reads_( num_keys ) const char* const* provider_options_keys, _In_reads_( num_keys ) const char* const* provider_options_values, _In_ size_t num_keys );
		 ...
		 * \since Version 1.18.
		 */
		ORT_API2_STATUS( SessionOptionsAppendExecutionProvider_VitisAI, _In_ OrtSessionOptions* options, _In_reads_( num_keys ) const char* const* provider_options_keys, _In_reads_( num_keys ) const char* const* provider_options_values, _In_ size_t num_keys );
		 ...
		 * \since Version 1.20.
		 */
		ORT_API2_STATUS( CreateLoraAdapter, const ORTCHAR_T* adapter_file_path, _In_ OrtAllocator* allocator, _Outptr_ OrtLoraAdapter** out );
		 ...
		 * \since Version 1.20.
		 */
		ORT_API2_STATUS( CreateLoraAdapterFromArray, _In_ const void* bytes, size_t num_bytes, _In_ OrtAllocator* allocator, _Outptr_ OrtLoraAdapter** out );
		 ...
		 * \since Version 1.20.
		 */
		ORT_API2_STATUS( SetEpDynamicOptions, _Inout_ OrtSession* sess, _In_reads_( kv_len ) const char* const* keys, _In_reads_( kv_len ) const char* const* values, _In_ size_t kv_len );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( CreateTensorWithDataAndDeleterAsOrtValue, _In_ OrtAllocator* deleter, _In_ void* p_data, size_t p_data_len, _In_ const int64_t* shape, size_t shape_len, ONNXTensorElementDataType type, _Outptr_ OrtValue** out );
		 ...
		 * \since Version 1.22.
		 */
		void( ORT_API_CALL* GetKeyValuePairs )( _In_ const OrtKeyValuePairs* kvps, _Outptr_ const char* const** keys, _Outptr_ const char* const** values, _Out_ size_t* num_entries );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( RegisterExecutionProviderLibrary, _In_ OrtEnv* env, _In_ const char* registration_name, _In_ const ORTCHAR_T* path );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( GetEpDevices, _In_ const OrtEnv* env, _Outptr_ const OrtEpDevice* const** ep_devices, _Out_ size_t* num_ep_devices );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( SessionOptionsAppendExecutionProvider_V2, _In_ OrtSessionOptions* session_options, _In_ OrtEnv* env, _In_reads_( num_ep_devices ) const OrtEpDevice* const* ep_devices, _In_ size_t num_ep_devices, _In_reads_( num_op_options ) const char* const* ep_option_keys, _In_reads_( num_op_options ) const char* const* ep_option_vals, size_t num_ep_options );
		 ...
		 * \since Version 1.22
		 */
		ORT_API2_STATUS( SessionOptionsSetEpSelectionPolicy, _In_ OrtSessionOptions* session_options, _In_ OrtExecutionProviderDevicePolicy policy );
		 ...
		 * \since Version 1.22
		 */
		ORT_API2_STATUS( SessionOptionsSetEpSelectionPolicyDelegate, _In_ OrtSessionOptions* session_options, _In_ EpSelectionDelegate delegate, _In_opt_ void* delegate_state );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_GetValueProducer, _In_ const OrtValueInfo* value_info, _Outptr_ const OrtNode** producer_node, _Out_opt_ size_t* producer_output_index );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_GetValueConsumers, _In_ const OrtValueInfo* value_info, _Out_writes_all_( num_consumers ) const OrtNode** nodes, _Out_writes_all_( num_consumers ) int64_t* input_indices, _In_ size_t num_consumers );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_GetInitializerValue, _In_ const OrtValueInfo* value_info, _Outptr_ const OrtValue** initializer_value );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_GetExternalInitializerInfo, _In_ const OrtValueInfo* value_info, _Outptr_result_maybenull_ OrtExternalInitializerInfo** info );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_IsRequiredGraphInput, _In_ const OrtValueInfo* value_info, _Out_ bool* is_required_graph_input );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_IsOptionalGraphInput, _In_ const OrtValueInfo* value_info, _Out_ bool* is_optional_graph_input );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValueInfo_IsConstantInitializer, _In_ const OrtValueInfo* value_info, _Out_ bool* is_constant_initializer );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetOperatorSets, _In_ const OrtGraph* graph, _Out_writes_( num_operator_sets ) const char** domains, _Out_writes_( num_operator_sets ) int64_t* opset_versions, _In_ size_t num_operator_sets );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetInputs, _In_ const OrtGraph* graph, _Out_writes_( num_inputs ) const OrtValueInfo** inputs, _In_ size_t num_inputs );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetOutputs, _In_ const OrtGraph* graph, _Out_writes_( num_outputs ) const OrtValueInfo** outputs, _In_ size_t num_outputs );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetInitializers, _In_ const OrtGraph* graph, _Out_writes_( num_initializers ) const OrtValueInfo** initializers, _In_ size_t num_initializers );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetNodes, _In_ const OrtGraph* graph, _Out_writes_( num_nodes ) const OrtNode** nodes, _In_ size_t num_nodes );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Graph_GetGraphView, _In_ const OrtGraph* src_graph, _In_ const OrtNode** nodes, _In_ size_t num_nodes, _Outptr_ OrtGraph** dst_graph );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetInputs, _In_ const OrtNode* node, _Out_writes_( num_inputs ) const OrtValueInfo** inputs, _In_ size_t num_inputs );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetOutputs, _In_ const OrtNode* node, _Out_writes_( num_outputs ) const OrtValueInfo** outputs, _In_ size_t num_outputs );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetImplicitInputs, _In_ const OrtNode* node, _Out_writes_( num_implicit_inputs ) const OrtValueInfo** implicit_inputs, _In_ size_t num_implicit_inputs );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetAttributes, _In_ const OrtNode* node, _Out_writes_( num_attributes ) const OrtOpAttr** attributes, _In_ size_t num_attributes );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetAttributeByName, _In_ const OrtNode* node, _In_ const char* attribute_name, _Outptr_result_maybenull_ const OrtOpAttr** attribute );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( OpAttr_GetTensorAttributeAsOrtValue, _In_ const OrtOpAttr* attribute, _Outptr_result_maybenull_ OrtValue** attr_tensor );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Node_GetSubgraphs, _In_ const OrtNode* node, _Out_writes_( num_subgraphs ) const OrtGraph** subgraphs, _In_ size_t num_subgraphs, _Out_writes_opt_( num_subgraphs ) const char** attribute_names );
		 ...
		 * \since Version 1.23
		 */
		ORT_API_T( const OrtMemoryInfo*, EpDevice_MemoryInfo, _In_ const OrtEpDevice* ep_device, _In_ OrtDeviceMemoryType memory_type );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( CreateSharedAllocator, _In_ OrtEnv* env, _In_ const OrtEpDevice* ep_device, _In_ OrtDeviceMemoryType mem_type, _In_ OrtAllocatorType allocator_type, _In_opt_ const OrtKeyValuePairs* allocator_options, _Outptr_opt_ OrtAllocator** allocator );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( GetSharedAllocator, _In_ OrtEnv* env, _In_ const OrtMemoryInfo* mem_info, _Outptr_result_maybenull_ OrtAllocator** allocator );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( ReleaseSharedAllocator, _In_ OrtEnv* env, _In_ const OrtEpDevice* ep_device, _In_ OrtDeviceMemoryType mem_type );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( SessionGetMemoryInfoForInputs, _In_ const OrtSession* session, _Out_writes_( num_inputs ) const OrtMemoryInfo** inputs_memory_info, _In_ size_t num_inputs );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( SessionGetMemoryInfoForOutputs, _In_ const OrtSession* session, _Out_writes_( num_outputs ) const OrtMemoryInfo** outputs_memory_info, _In_ size_t num_outputs );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( SessionGetEpDeviceForInputs, _In_ const OrtSession* session, _Out_writes_( num_inputs ) const OrtEpDevice** inputs_ep_devices, _In_ size_t num_inputs );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( CreateSyncStreamForEpDevice, _In_ const OrtEpDevice* ep_device, _In_opt_ const OrtKeyValuePairs* stream_options, _Outptr_ OrtSyncStream** stream );
		 ...
		 * \since Version 1.23
		 */
		ORT_API2_STATUS( CopyTensors, _In_ const OrtEnv* env, _In_reads_( num_tensors ) const OrtValue* const* src_tensors, _In_reads_( num_tensors ) OrtValue* const* dst_tensors, _In_opt_ OrtSyncStream* stream, _In_ size_t num_tensors );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( GetModelCompatibilityForEpDevices, _In_reads_( num_ep_devices ) const OrtEpDevice* const* ep_devices, _In_ size_t num_ep_devices, _In_ const char* compatibility_info, _Out_ OrtCompiledModelCompatibility* out_status );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateExternalInitializerInfo, _In_ const ORTCHAR_T* filepath, _In_ int64_t file_offset, _In_ size_t byte_size, _Outptr_ OrtExternalInitializerInfo** out );
		 ...
		 * \since Version 1.24
		 */
		ORT_API2_STATUS( KernelInfo_GetOperatorDomain, _In_ const OrtKernelInfo* info, _Out_opt_ char* out, _Inout_ size_t* size );
		 ...
		 * \since Version 1.24
		 */
		ORT_API2_STATUS( KernelInfo_GetOperatorType, _In_ const OrtKernelInfo* info, _Out_opt_ char* out, _Inout_ size_t* size );
		 ...
		 * \since Version 1.24
		 */
		ORT_API2_STATUS( SessionGetEpDeviceForOutputs, _In_ const OrtSession* session, _Out_writes_( num_outputs ) const OrtEpDevice** outputs_ep_devices, _In_ size_t num_outputs );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetHardwareDevices, _In_ const OrtEnv* env, _Out_writes_( num_devices ) const OrtHardwareDevice** devices, _In_ size_t num_devices );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetHardwareDeviceEpIncompatibilityDetails, _In_ const OrtEnv* env, _In_ const char* ep_name, _In_ const OrtHardwareDevice* hw, _Outptr_ OrtDeviceEpIncompatibilityDetails** details );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( DeviceEpIncompatibilityDetails_GetReasonsBitmask, _In_ const OrtDeviceEpIncompatibilityDetails* details, _Out_ uint32_t* reasons_bitmask );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( DeviceEpIncompatibilityDetails_GetNotes, _In_ const OrtDeviceEpIncompatibilityDetails* details, _Outptr_result_maybenull_ const char** notes );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( DeviceEpIncompatibilityDetails_GetErrorCode, _In_ const OrtDeviceEpIncompatibilityDetails* details, _Out_ int32_t* error_code );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetCompatibilityInfoFromModel, _In_ const ORTCHAR_T* model_path, _In_ const char* ep_type, _Inout_ OrtAllocator* allocator, _Outptr_result_maybenull_ char** compatibility_info );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetCompatibilityInfoFromModelBytes, _In_reads_( model_data_length ) const void* model_data, _In_ size_t model_data_length, _In_ const char* ep_type, _Inout_ OrtAllocator* allocator, _Outptr_result_maybenull_ char** compatibility_info );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( Session_GetEpGraphAssignmentInfo, _In_ const OrtSession* session, _Outptr_ const OrtEpAssignedSubgraph* const** ep_subgraphs, _Out_ size_t* num_ep_subgraphs );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( EpAssignedSubgraph_GetEpName, _In_ const OrtEpAssignedSubgraph* ep_subgraph, _Outptr_ const char** out );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( EpAssignedSubgraph_GetNodes, _In_ const OrtEpAssignedSubgraph* ep_subgraph, _Outptr_ const OrtEpAssignedNode* const** ep_nodes, _Out_ size_t* num_ep_nodes );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetTensorElementTypeAndShapeDataReference, _In_ const OrtValue* value, _Out_ ONNXTensorElementDataType* elem_type, _Outptr_result_maybenull_ const int64_t** shape_data, _Out_ size_t* shape_data_count );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( KernelInfoGetAttributeArray_string, _In_ const OrtKernelInfo* info, _In_ const char* name, _Inout_ OrtAllocator* allocator, _Outptr_result_buffer_maybenull_( *size ) char*** out, _Out_ size_t* size );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( SetPerSessionThreadPoolCallbacks, _Inout_ OrtEnv* env, _In_ const OrtThreadPoolCallbacksConfig* config );
		 ...
		 * \since Version 1.28.
		 */
		ORT_API2_STATUS( KernelContext_GetSyncStream, _In_ const OrtKernelContext* context, _Outptr_result_maybenull_ OrtSyncStream** out );
		 ...
		 * \since Version 1.29.
		 */
		ORT_API2_STATUS( SessionOptionsSetWeightlessSourceModelBuffer, _Inout_ OrtSessionOptions* options, _In_ const void* source_model_data, _In_ size_t source_model_data_length );
		 ...
		 * \since Version 1.30.
		 */
		ORT_API2_STATUS( KernelContext_GetPreallocatedOutput, _In_ const OrtKernelContext* context, _In_ size_t output_index, _Outptr_result_maybenull_ OrtValue** output );
	};
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateTensorTypeInfo, _In_ const OrtTensorTypeAndShapeInfo* tensor_info, _Outptr_ OrtTypeInfo** type_info );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateSparseTensorTypeInfo, _In_ const OrtTensorTypeAndShapeInfo* tensor_info, _Outptr_ OrtTypeInfo** type_info );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateMapTypeInfo, ONNXTensorElementDataType map_key_type, _In_ const OrtTypeInfo* map_value_type, _Outptr_ OrtTypeInfo** type_info );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateValueInfo, _In_ const char* name, _In_ const OrtTypeInfo* type_info, _Outptr_ OrtValueInfo** value_info );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( SetGraphInputs, _Inout_ OrtGraph* graph, _In_reads_( inputs_len ) _Inout_ OrtValueInfo** inputs, _In_ size_t inputs_len );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( SetGraphOutputs, _Inout_ OrtGraph* graph, _In_reads_( outputs_len ) _Inout_ OrtValueInfo** outputs, _In_ size_t outputs_len );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( AddInitializerToGraph, _Inout_ OrtGraph* graph, _In_ const char* name, _Inout_ OrtValue* tensor, bool data_is_external );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateModel, _In_reads_( opset_entries_len ) const char* const* domain_names, _In_reads_( opset_entries_len ) const int* opset_versions, size_t opset_entries_len, _Outptr_ OrtModel** model );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateSessionFromModel, _In_ const OrtEnv* env, _In_ const OrtModel* model, _In_ const OrtSessionOptions* options, _Outptr_ OrtSession** out );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateModelEditorSession, _In_ const OrtEnv* env, _In_ const ORTCHAR_T* model_path, _In_ const OrtSessionOptions* options, _Outptr_ OrtSession** out );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( CreateModelEditorSessionFromArray, _In_ const OrtEnv* env, _In_ const void* model_data, size_t model_data_length, _In_ const OrtSessionOptions* options, _Outptr_ OrtSession** out );
	 ...
	 * \since Version 1.22.
	 */
	ORT_API2_STATUS( FinalizeModelEditorSession, _Inout_ OrtSession* session, _In_ const OrtSessionOptions* options, _In_opt_ OrtPrepackedWeightsContainer* prepacked_weights_container );
	...
	struct OrtCompileApi
	{
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( CreateModelCompilationOptionsFromSessionOptions, _In_ const OrtEnv* env, _In_ const OrtSessionOptions* session_options, _Outptr_ OrtModelCompilationOptions** out );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetInputModelPath, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const ORTCHAR_T* input_model_path );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetInputModelFromBuffer, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const void* input_model_data, size_t input_model_data_size );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetOutputModelPath, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const ORTCHAR_T* output_model_path );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetOutputModelExternalInitializersFile, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const ORTCHAR_T* external_initializers_file_path, size_t external_initializers_size_threshold );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetOutputModelBuffer, _In_ OrtModelCompilationOptions* model_compile_options, _Inout_ OrtAllocator* allocator, _Outptr_ void** output_model_buffer_ptr, _Out_ size_t* output_model_buffer_size_ptr );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetEpContextEmbedMode, _In_ OrtModelCompilationOptions* model_compile_options, bool embed_ep_context_in_model );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetFlags, _In_ OrtModelCompilationOptions* model_compile_options, uint32_t flags );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetEpContextBinaryInformation, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const ORTCHAR_T* output_directory, _In_ const ORTCHAR_T* model_name );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetGraphOptimizationLevel, _In_ OrtModelCompilationOptions* model_compile_options, _In_ GraphOptimizationLevel graph_optimization_level );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetOutputModelWriteFunc, _In_ OrtModelCompilationOptions* model_compile_options, _In_ OrtWriteBufferFunc write_func, _In_ void* state );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetOutputModelGetInitializerLocationFunc, _In_ OrtModelCompilationOptions* model_compile_options, _In_ OrtGetInitializerLocationFunc get_initializer_location_func, _In_ void* state );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetInputModel, _In_ OrtModelCompilationOptions* model_compile_options, _In_ const OrtModel* model );
		 ...
		 * \since Version 1.29.
		 */
		ORT_API2_STATUS( ModelCompilationOptions_SetWeightlessEnabled, _In_ OrtModelCompilationOptions* model_compile_options, _In_ bool use_weightless );
	};
	...
	struct OrtInteropApi
	{
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CreateExternalResourceImporterForDevice, _In_ const OrtEpDevice* ep_device, _Outptr_result_maybenull_ OrtExternalResourceImporter** out_importer );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CanImportMemory, _In_ const OrtExternalResourceImporter* importer, _In_ OrtExternalMemoryHandleType handle_type, _Out_ bool* out_supported );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ImportMemory, _In_ OrtExternalResourceImporter* importer, _In_ const OrtExternalMemoryDescriptor* desc, _Outptr_ OrtExternalMemoryHandle** out_handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CreateTensorFromMemory, _In_ OrtExternalResourceImporter* importer, _In_ const OrtExternalMemoryHandle* mem_handle, _In_ const OrtExternalTensorDescriptor* tensor_desc, _Outptr_ OrtValue** out_tensor );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CanImportSemaphore, _In_ const OrtExternalResourceImporter* importer, _In_ OrtExternalSemaphoreType type, _Out_ bool* out_supported );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ImportSemaphore, _In_ OrtExternalResourceImporter* importer, _In_ const OrtExternalSemaphoreDescriptor* desc, _Outptr_ OrtExternalSemaphoreHandle** out_handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( WaitSemaphore, _In_ OrtExternalResourceImporter* importer, _In_ OrtExternalSemaphoreHandle* semaphore_handle, _In_ OrtSyncStream* stream, _In_ uint64_t value );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( SignalSemaphore, _In_ OrtExternalResourceImporter* importer, _In_ OrtExternalSemaphoreHandle* semaphore_handle, _In_ OrtSyncStream* stream, _In_ uint64_t value );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( InitGraphicsInteropForEpDevice, _In_ const OrtEpDevice* ep_device, _In_ const OrtGraphicsInteropConfig* config );
