...
extern "C"
{
	...
	struct OrtDataTransferImpl
	{
		 ...
		 * \since Version 1.23.
		 */
		ORT_API_T( bool, CanCopy, _In_ const OrtDataTransferImpl* this_ptr, _In_ const OrtMemoryDevice* src_memory_device, _In_ const OrtMemoryDevice* dst_memory_device );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CopyTensors, _In_ OrtDataTransferImpl* this_ptr, _In_reads_( num_tensors ) const OrtValue** src_tensors, _In_reads_( num_tensors ) OrtValue** dst_tensors, _In_reads_( num_tensors ) OrtSyncStream** streams, _In_ size_t num_tensors );
	};
	...
	struct OrtSyncStreamImpl
	{
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateNotification, _In_ OrtSyncStreamImpl* this_ptr, _Outptr_ OrtSyncNotificationImpl** notification );
	...
	struct OrtExternalResourceImporterImpl
	{
		 ...
		 * \since Version 1.24.
		 */
		ORT_API_T( bool, CanImportMemory, _In_ const OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalMemoryHandleType handle_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ImportMemory, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ const OrtExternalMemoryDescriptor* desc, _Outptr_ OrtExternalMemoryHandle** out_handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API_T( void, ReleaseMemory, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalMemoryHandle* handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CreateTensorFromMemory, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ const OrtExternalMemoryHandle* mem_handle, _In_ const OrtExternalTensorDescriptor* tensor_desc, _Outptr_ OrtValue** out_tensor );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API_T( bool, CanImportSemaphore, _In_ const OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalSemaphoreType type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ImportSemaphore, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ const OrtExternalSemaphoreDescriptor* desc, _Outptr_ OrtExternalSemaphoreHandle** out_handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API_T( void, ReleaseSemaphore, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalSemaphoreHandle* handle );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( WaitSemaphore, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalSemaphoreHandle* handle, _In_ OrtSyncStream* stream, _In_ uint64_t value );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( SignalSemaphore, _In_ OrtExternalResourceImporterImpl* this_ptr, _In_ OrtExternalSemaphoreHandle* handle, _In_ OrtSyncStream* stream, _In_ uint64_t value );
	...
	struct OrtEpProfilerImpl
	{
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( StopEvent, _In_ OrtEpProfilerImpl* this_ptr, _In_ uint64_t ort_event_correlation_id, _In_ const OrtProfilingEvent* ort_event );
	...
	struct OrtNodeComputeInfo
	{
		 ...
		 * \since Version 1.23.
		 */
		OrtStatus*( ORT_API_CALL* CreateState )( _In_ OrtNodeComputeInfo* this_ptr, _In_ OrtNodeComputeContext* compute_context, _Outptr_ void** compute_state );
		 ...
		 * \since Version 1.23.
		 */
		OrtStatus*( ORT_API_CALL* Compute )( _In_ OrtNodeComputeInfo* this_ptr, _In_ void* compute_state, _In_ OrtKernelContext* kernel_context );
	...
	struct OrtKernelImpl
	{
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( PrePackWeight, _In_ OrtKernelImpl* this_ptr, _In_ const OrtValue* tensor, _In_ int input_index, _Inout_ OrtAllocator* allocator, _In_opt_ OrtSharedPrePackedWeightCache* prepacked_weight_cache, _Out_ bool* is_packed );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( SetSharedPrePackedWeight, _In_ OrtKernelImpl* this_ptr, _In_reads_( num_buffers ) const void* const* buffer_data_ptrs, _In_reads_( num_buffers ) const size_t* buffer_data_sizes, _In_ size_t num_buffers, _In_ int input_index );
	};
	 ...
	 * \since Version 1.24.
	 */
	typedef OrtStatus*( ORT_API_CALL* OrtKernelCreateFunc )( _In_ void* kernel_create_func_state, _In_ const OrtKernelInfo* info, _Outptr_result_maybenull_ OrtKernelImpl** kernel_out );
	...
	struct OrtLoopKernelHelper
	{
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( ConcatOutput, _In_ OrtLoopKernelHelper* this_ptr, _In_opt_ void* stream_handle, _In_reads_( num_per_iteration_outputs ) const OrtValue* const* per_iteration_outputs, _In_ size_t num_per_iteration_outputs, _Out_writes_bytes_all_( output_size_in_bytes ) void* output, _In_ size_t output_size_in_bytes );
	};
	...
	struct OrtScanKernelHelper
	{
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( Transpose, _In_ OrtScanKernelHelper* this_ptr, _In_reads_( num_permutation_elems ) const size_t* permutation, _In_ size_t num_permutation_elems, _In_ const OrtValue* input, _In_opt_ OrtSyncStream* stream, _Inout_ OrtValue* output );
	};
	...
	typedef struct OrtResourceCount
	{
		...
		OrtResourceCount() noexcept :
			kind{ OrtResourceCountKind_None },
			reserved{ 0 },
			value{}
		{
		}
	...
	struct OrtEpApi
	{
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( CreateEpDevice, _In_ OrtEpFactory* ep_factory, _In_ const OrtHardwareDevice* hardware_device, _In_opt_ const OrtKeyValuePairs* ep_metadata, _In_opt_ const OrtKeyValuePairs* ep_options, _Out_ OrtEpDevice** ep_device );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( EpGraphSupportInfo_AddNodesToFuse, _In_ OrtEpGraphSupportInfo* graph_support_info, _In_reads_( num_nodes ) const OrtNode* const* nodes, _In_ size_t num_nodes, _In_opt_ const OrtNodeFusionOptions* node_fusion_options );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( EpGraphSupportInfo_AddSingleNode, _In_ OrtEpGraphSupportInfo* graph_support_info, _In_ const OrtNode* node );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( EpDevice_AddAllocatorInfo, _In_ OrtEpDevice* ep_device, _In_ const OrtMemoryInfo* allocator_memory_info );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API_T( uint64_t, GetSyncIdForLastWaitOnSyncStream, _In_ const OrtSyncStream* producer_stream, _In_ const OrtSyncStream* consumer_stream );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( CreateHardwareDevice, _In_ OrtHardwareDeviceType type, _In_ uint32_t vendor_id, _In_ uint32_t device_id, _In_ const char* vendor_name, _In_opt_ const OrtKeyValuePairs* metadata, _Out_ OrtHardwareDevice** hardware_device );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelRegistry_AddKernel, _In_ OrtKernelRegistry* kernel_registry, _In_ const OrtKernelDef* kernel_def, _In_ OrtKernelCreateFunc kernel_create_func, _In_ void* kernel_create_func_state );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_SetOperatorType, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ const char* op_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_SetSinceVersion, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ int since_version_start, _In_ int since_version_end );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_SetExecutionProvider, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ const char* ep_name );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_SetInputMemType, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ size_t input_index, _In_ OrtMemType mem_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_SetOutputMemType, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ size_t output_index, _In_ OrtMemType mem_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_AddTypeConstraint, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_ const char* arg_name, _In_reads_( num_types ) const OrtDataType* const* types, _In_ size_t num_types );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_AddInputOutputAliases, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_reads_( num_io_indices ) int const* input_indices, _In_reads_( num_io_indices ) int const* output_indices, _In_ size_t num_io_indices );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_AddInputOutputMutableAliases, _In_ OrtKernelDefBuilder* kernel_def_builder, _In_reads_( num_io_indices ) int const* input_indices, _In_reads_( num_io_indices ) int const* output_indices, _In_ size_t num_io_indices );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDefBuilder_Build, _In_ OrtKernelDefBuilder* kernel_def_builder, _Outptr_ OrtKernelDef** kernel_def_out );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDef_GetSinceVersion, _In_ const OrtKernelDef* kernel_def, _Out_ int* start_version, _Out_ int* end_version );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDef_GetInputMemType, _In_ const OrtKernelDef* kernel_def, _In_ size_t input_index, _Out_ OrtMemType* mem_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( KernelDef_GetOutputMemType, _In_ const OrtKernelDef* kernel_def, _In_ size_t output_index, _Out_ OrtMemType* mem_type );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( EpGraphSupportInfo_LookUpKernel, _In_ OrtEpGraphSupportInfo* graph_support_info, _In_ const OrtNode* node, _Outptr_result_maybenull_ const OrtKernelDef** out_kernel_def );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( SharedPrePackedWeightCache_StoreWeightData, _In_ OrtSharedPrePackedWeightCache* prepacked_weight_cache, _In_reads_( num_buffers ) void** buffer_data_ptrs, _In_reads_( num_buffers ) size_t* buffer_data_sizes, _In_ size_t num_buffers );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( DeviceEpIncompatibilityDetails_SetDetails, _Inout_ OrtDeviceEpIncompatibilityDetails* details, _In_ uint32_t reasons_bitmask, _In_ int32_t error_code, _In_opt_z_ const char* notes );
		 ...
		 * \since Version 1.24
		 */
		ORT_API2_STATUS( CreateLoopKernel, _In_ const OrtKernelInfo* kernel_info, _In_ OrtLoopKernelHelper* helper, _Outptr_ OrtKernelImpl** kernel_out );
		 ...
		 * \since Version 1.24
		 */
		ORT_API2_STATUS( CreateScanKernel, _In_ const OrtKernelInfo* kernel_info, _In_ OrtScanKernelHelper* helper, _Outptr_ OrtKernelImpl** kernel_out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( GetOpSchema, _In_ const char* name, _In_ int max_inclusive_version, _In_ const char* domain, _Outptr_result_maybenull_ OrtOpSchema** out_schema );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchema_GetInputName, _In_ const OrtOpSchema* schema, _In_ size_t index, _Outptr_ const char** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchema_GetInputTypeConstraint, _In_ const OrtOpSchema* schema, _In_ size_t index, _Outptr_result_maybenull_ const OrtOpSchemaTypeConstraint** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchema_GetOutputName, _In_ const OrtOpSchema* schema, _In_ size_t index, _Outptr_ const char** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchema_GetOutputTypeConstraint, _In_ const OrtOpSchema* schema, _In_ size_t index, _Outptr_result_maybenull_ const OrtOpSchemaTypeConstraint** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchema_GetTypeConstraint, _In_ const OrtOpSchema* schema, _In_ size_t index, _Outptr_ const OrtOpSchemaTypeConstraint** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchemaTypeConstraint_GetTypeParamName, _In_ const OrtOpSchemaTypeConstraint* type_constraint, _Outptr_ const char** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchemaTypeConstraint_GetAllowedTypes, _In_ const OrtOpSchemaTypeConstraint* type_constraint, _Outptr_ const char* const** out_types, _Out_ size_t* num_types );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchemaTypeConstraint_GetInputIndices, _In_ const OrtOpSchemaTypeConstraint* type_constraint, _Outptr_ const size_t** out_indices, _Out_ size_t* count );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( OpSchemaTypeConstraint_GetOutputIndices, _In_ const OrtOpSchemaTypeConstraint* type_constraint, _Outptr_ const size_t** out_indices, _Out_ size_t* count );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( CreateProfilingEvent, _In_ OrtProfilingEventCategory category, _In_ int32_t process_id, _In_ int32_t thread_id, _In_ const char* event_name, _In_ int64_t timestamp_us, _In_ int64_t duration_us, _In_reads_( num_args ) const char* const* arg_keys, _In_reads_( num_args ) const char* const* arg_values, _In_ size_t num_args, _Outptr_ OrtProfilingEvent** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( ProfilingEvent_GetCategory, _In_ const OrtProfilingEvent* event, _Out_ OrtProfilingEventCategory* out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( ProfilingEvent_GetArgValue, _In_ const OrtProfilingEvent* event, _In_ const char* key, _Outptr_result_maybenull_ const char** out );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( ProfilingEventsContainer_AddEvents, _In_ OrtProfilingEventsContainer* events_container, _In_reads_( num_events ) const OrtProfilingEvent* const* events, _In_ size_t num_events );
		 ...
		 * \since Version 1.29.
		 */
		ORT_API2_STATUS( SessionOptionsGetWeightlessSourceModelBuffer, _In_ const OrtSessionOptions* session_options, _Outptr_result_maybenull_ const void** source_model_data, _Out_ size_t* source_model_data_length );
	};
	...
	struct OrtEp
	{
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( GetCapability, _In_ OrtEp* this_ptr, _In_ const OrtGraph* graph, _Inout_ OrtEpGraphSupportInfo* graph_support_info );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( Compile, _In_ OrtEp* this_ptr, _In_ const OrtGraph** graphs, _In_ const OrtNode** fused_nodes, _In_ size_t count, _Out_writes_all_( count ) OrtNodeComputeInfo** node_compute_infos, _Out_writes_( count ) OrtNode** ep_context_nodes );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API_T( void, ReleaseNodeComputeInfos, _In_ OrtEp* this_ptr, OrtNodeComputeInfo** node_compute_infos, _In_ size_t num_node_compute_infos );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ShouldConvertDataLayoutForOp, _In_ OrtEp* this_ptr, _In_z_ const char* domain, _In_z_ const char* op_type, _In_ OrtEpDataLayout target_data_layout, _Outptr_ int* should_convert );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( SetDynamicOptions, _In_ OrtEp* this_ptr, _In_reads_( num_options ) const char* const* option_keys, _In_reads_( num_options ) const char* const* option_values, _In_ size_t num_options );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateAllocator, _In_ OrtEp* this_ptr, _In_ const OrtMemoryInfo* memory_info, _Outptr_result_maybenull_ OrtAllocator** allocator );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateSyncStreamForDevice, _In_ OrtEp* this_ptr, _In_ const OrtMemoryDevice* memory_device, _Outptr_ OrtSyncStreamImpl** stream );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetKernelRegistry, _In_ OrtEp* this_ptr, _Outptr_result_maybenull_ const OrtKernelRegistry** kernel_registry );
		 ...
		 * \since Version 1.27.
		 */
		ORT_API2_STATUS( GetDefaultMemoryDevice, _In_ const OrtEp* this_ptr, _Outptr_result_maybenull_ const OrtMemoryDevice** device );
	...
	struct OrtEpFactory
	{
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( GetSupportedDevices, _In_ OrtEpFactory* this_ptr, _In_reads_( num_devices ) const OrtHardwareDevice* const* devices, _In_ size_t num_devices, _Inout_ OrtEpDevice** ep_devices, _In_ size_t max_ep_devices, _Out_ size_t* num_ep_devices );
		 ...
		 * \since Version 1.22.
		 */
		ORT_API2_STATUS( CreateEp, _In_ OrtEpFactory* this_ptr, _In_reads_( num_devices ) const OrtHardwareDevice* const* devices, _In_reads_( num_devices ) const OrtKeyValuePairs* const* ep_metadata_pairs, _In_ size_t num_devices, _In_ const OrtSessionOptions* session_options, _In_ const OrtLogger* logger, _Outptr_ OrtEp** ep );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( ValidateCompiledModelCompatibilityInfo, _In_ OrtEpFactory* this_ptr, _In_reads_( num_devices ) const OrtHardwareDevice* const* devices, _In_ size_t num_devices, _In_ const char* compatibility_info, _Out_ OrtCompiledModelCompatibility* model_compatibility );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateAllocator, _In_ OrtEpFactory* this_ptr, _In_ const OrtMemoryInfo* memory_info, _In_opt_ const OrtKeyValuePairs* allocator_options, _Outptr_result_maybenull_ OrtAllocator** allocator );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateDataTransfer, _In_ OrtEpFactory* this_ptr, _Outptr_result_maybenull_ OrtDataTransferImpl** data_transfer );
		 ...
		 * \since Version 1.23.
		 */
		ORT_API2_STATUS( CreateSyncStreamForDevice, _In_ OrtEpFactory* this_ptr, _In_ const OrtMemoryDevice* memory_device, _In_opt_ const OrtKeyValuePairs* stream_options, _Outptr_ OrtSyncStreamImpl** stream );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetHardwareDeviceIncompatibilityDetails, _In_ OrtEpFactory* this_ptr, _In_ const OrtHardwareDevice* hw, _Inout_ OrtDeviceEpIncompatibilityDetails* details );
		 ...
		 * \since Version 1.24.
		 */
		ORT_API2_STATUS( GetCustomOpDomains, _In_ OrtEpFactory* this_ptr, _Out_writes_all_( num_domains ) OrtCustomOpDomain** domains, _In_ size_t num_domains );
		 ...
		 * \since Version 1.25.
		 */
		ORT_API2_STATUS( InitGraphicsInterop, _In_ OrtEpFactory* this_ptr, _In_ const OrtEpDevice* ep_device, _In_ const OrtGraphicsInteropConfig* config );
		 ...
		 * \since Version 1.28.
		 */
		ORT_API2_STATUS( SelectBestModelCandidate, _In_ OrtEpFactory* this_ptr, _In_ const OrtHardwareDevice* device, _In_reads_( num_candidates ) const OrtKeyValuePairs* const* candidates, _In_ size_t num_candidates, _In_opt_ const OrtSessionOptions* session_options, _Out_ size_t* selected_index );
	};
